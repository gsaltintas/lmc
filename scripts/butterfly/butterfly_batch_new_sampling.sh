...
--cleanup_after=false --use_wandb true --group=noise-sampled-at-t --run_name=perm-$perturb_mode@${perturb_step}x$scale-lr=$lr-$repetition --project=ButterflyBatchNoiseNew --n_models=2 --seed1=$seed1 --loader_seed1=$seed1 \
