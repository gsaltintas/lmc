...
class TestConfig(BaseTest):
    ...
    def test_build(self):
        ...
        Path(file_dct["model_dir"]).mkdir(exist_ok=True)    
    ...
    def test_cmd_same_as_yaml(self):
        ...
        """
======================================================================
ERROR: test_cmd_same_as_yaml (tests.test_config_from_yaml.TestConfig) [identical run]
----------------------------------------------------------------------
...
AttributeError: 'NoneType' object has no attribute 'seek'
        ...
        with self.subTest("command line vs config file"):
            ...
            command = self.get_test_command(perturb_scale=PERTURB_SCALE)
